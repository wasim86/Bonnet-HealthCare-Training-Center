...
interface SecondaryBoatFormProps {
  boatNumber: number
...
export default function SecondaryBoatForm({
  boatNumber,
  onSubmit,
  onRemove,
  className = '',
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            ...
            <h3 className="text-2xl font-bold text-green-800">Boat #{boatNumber} - Submitted</h3>
          </div>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-gray-900">Boat #{boatNumber}</h3>
        {onRemove && (
          <button
            type="button"
            onClick={onRemove}
