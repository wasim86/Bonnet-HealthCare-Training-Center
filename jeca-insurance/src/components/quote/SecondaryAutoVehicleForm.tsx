...
interface SecondaryAutoVehicleFormProps {
...
export default function SecondaryAutoVehicleForm({
  vehicleNumber,
  onSubmit,
  onRemove,
  className = '',
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-2xl font-bold text-gray-900">Vehicle #{vehicleNumber} - Submitted</h3>
        </div>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-2xl font-bold text-gray-900">Vehicle #{vehicleNumber}</h3>
        {onRemove && (
          <button
            type="button"
            onClick={onRemove}
