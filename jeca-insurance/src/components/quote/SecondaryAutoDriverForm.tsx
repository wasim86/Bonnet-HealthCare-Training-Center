...
interface SecondaryAutoDriverFormProps {
  driverNumber: number
...
export default function SecondaryAutoDriverForm({
  driverNumber,
  onSubmit,
  onRemove,
  className = '',
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-2xl font-bold text-gray-900">Driver #{driverNumber} - Submitted</h3>
        </div>
